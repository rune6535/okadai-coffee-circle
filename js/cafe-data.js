...
const CAFE_DATA = {
  cafes: [
    ...
    },
    {
      ...
      timeSlots: ["昼", "夜"],
      comment:
        "後楽園近くの落ち着いたカフェ。居心地の良い空間で、ゆったりとした時間を過ごせます。",
      visitDate: "2025年11月",
      images: [
    ...
    },
    {
      ...
      features: ["おしゃれな空間", "スイーツが美味しい", "駐車場あり"],
      timeSlots: ["昼", "夜"],
      comment:
        "JFE晴れの国スタジアムのすぐ近く。駐車場もあり、アクセスしやすいカフェです。",
      visitDate: "2025年10月",
      images: [
    ...
    },
    {
      ...
      features: ["おしゃれな空間", "静かで落ち着く", "スイーツが美味しい"],
      timeSlots: ["昼", "夜", "深夜"],
      comment: "夜遅くまで営業しているカフェ。夜カフェとしても楽しめる貴重なお店です。",
      visitDate: "2025年9月",
      images: [
    ...
    },
    {
      ...
      timeSlots: ["昼", "夜", "深夜"],
      comment:
        "夜遅くまで営業している、雰囲気の良いカフェ。落ち着いた空間で大人の時間を楽しめます。",
      visitDate: "2025年8月",
      images: [
    ...
    },
    {
      ...
      features: ["おしゃれな空間", "静かで落ち着く", "作業しやすい", "スイーツが美味しい"],
      timeSlots: ["昼"],
      comment: "レトロでおしゃれな雰囲気のカフェ。Wi-Fi完備で作業にも最適です。",
      visitDate: "2025年7月",
      ...
      phone: null,
      parking: "なし",
      instagram: "https://www.instagram.com/onsaya_coffee",
      googleMaps: "",
      hasFood: false,
      reservable: false,
    ...
    },
    {
      ...
      phone: null,
      parking: "なし",
      instagram: "https://www.instagram.com/empire_coffee",
      googleMaps: "",
      hasFood: false,
      reservable: false,
    ...
    },
    {
      ...
      phone: null,
      parking: "なし",
      instagram: "https://www.instagram.com/counter_coffee",
      googleMaps: "",
      hasFood: false,
      reservable: false,
    ...
    },
    {
      ...
      phone: null,
      parking: "なし",
      instagram: "https://www.instagram.com/iro_cafe",
      googleMaps: "",
      hasFood: true,
      reservable: false,
    ...
    },
    {
      ...
      features: ["おしゃれな空間", "静かで落ち着く", "駐車場あり"],
      timeSlots: ["朝", "昼"],
      comment: "和の雰囲気も感じるモダンな店内で、自家焙煎コーヒーをゆっくり楽しめます。",
      visitDate: "2025年3月",
      images: ["images/coming-soon.svg"],
      openingHours: "未登録",
      closedDays: "未登録",
