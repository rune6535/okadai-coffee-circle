  ...
  cafes: [
    {
      ...
      area: "表町・柳川",
      areaVariants: ["おもてちょう", "オモテチョウ", "やながわ", "ヤナガワ"],
    ...
    },
    {
      id: 3,
      name: "CAFE FILO",
      nameVariants: ["CAFE FILO", "FILO", "カフェフィロ", "かふぇふぃろ", "フィロ", "ふぃろ"],
      area: "岡山駅周辺",
      areaVariants: ["おかやまえき", "オカヤマエキ", "えきしゅうへん", "エキシュウヘン"],
    ...
    },
    {
      ...
      nameVariants: ["ONSAYA", "おんさや", "オンサヤ", "ONSAYA COFFEE", "ONSAYA COFFEE 奉還町本店"],
      area: "奉還町",
      areaVariants: ["ほうかんちょう", "ホウカンチョウ"],
      address: "岡山市北区",
    ...
    },
    {
      id: 8,
      name: "ごはんとおやつiro",
      nameVariants: ["ごはんとおやつiro", "iro", "いろ", "イロ", "ごはん", "おやつ", "ごはんとおやつ"],
      area: "岡山駅周辺",
      areaVariants: ["おかやまえき", "オカヤマエキ", "えきしゅうへん", "エキシュウヘン"],
      address: "岡山市北区",
    ...
    },
    {
      ...
      nameVariants: ["AROMA", "アロマ", "あろま", "AROMA COFFEE ROASTERY"],
      area: "表町・柳川",
      areaVariants: ["おもてちょう", "オモテチョウ", "やながわ", "ヤナガワ"],
      address: "岡山市北区",
    ...
    },
    {
      ...
      nameVariants: ["COUNTER", "カウンター", "かうんたー", "COUNTER COFFEE COUNTER"],
      area: "奉還町",
      areaVariants: ["ほうかんちょう", "ホウカンチョウ"],
      address: "岡山市北区",
